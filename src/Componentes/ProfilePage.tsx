                ...
                <div className="container">
                    <div className="content-center">
                        <div className="cc-profile-image">
                            <a href="#a">
                                <img src={personalInformation.photo} alt="imgg" />
                            </a>
                        </div>
                        ...
                        <a className="btn btn-primary smooth-scroll mr-2"
                            ...
                            data-data-aos-anchor="data-data-aos-anchor">{personalInformation.buttonHire}</a>
                        <a className="btn btn-primary" href="#a" data-data-aos="zoom-in"
                            data-data-aos-anchor="data-data-aos-anchor">{personalInformation.buttonCv}</a>
                    </div>
                </div>
